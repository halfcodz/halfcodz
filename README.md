...
<table>
  ...
  <tr>
    ...
    <td>
      <b>✅ 습관 형성을 돕는 To-Do List 앱</b>
    </td>
    <td>
      의지가 약한 사용자도 할 일을 꾸준히 관리하고 실천할 수 있도록 돕는 To-Do List 앱을 제작했습니다.
    </td>
    <td>
  ...
  <tr>
    ...
    <td>
      기부 정보를 제공하고 사용자의 참여를 돕는 웹 서비스를 제작했습니다.<br>
      React 기반 화면, Flask 서버, MySQL 데이터베이스를 활용했습니다.
    </td>
    <td>
